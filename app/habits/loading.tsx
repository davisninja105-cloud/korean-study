export default function HabitsLoading() {
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Streak hero */}
      <div className="h-32 w-full rounded-2xl bg-surface-2 animate-pulse" />
      ...
      {/* Heatmap */}
      <div className="flex flex-col gap-3">
        <div className="h-6 w-24 rounded bg-surface-2 animate-pulse" />
        <div className="h-40 w-full rounded-2xl bg-surface-2 animate-pulse" />
      </div>
    </div>
  )
}
