...
- [ ] 17-02-PLAN.md — Idempotent write path in `app/api/review/route.ts`: idempotencyKey validation + `$transaction([cardReview.update, reviewLog.create])` + P2002-as-success (HIST-01/02)
