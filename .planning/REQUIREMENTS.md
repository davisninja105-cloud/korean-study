...
- [x] **SYNC-02**: A Vercel Cron job runs daily and triggers exactly 1 lesson of sync via the existing `MAX_LESSONS_PER_SYNC=1` path (deployed and confirmed — 19-UAT.md)
