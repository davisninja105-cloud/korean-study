...
| Task 3: Settings `<h2>` → text-lg | ✓ | 7 headings upgraded |
...
- `app/settings/page.tsx` — 7 `<h2>` to `text-lg`

## Verification

- All grep assertions pass: Cards `aria-pressed` + `min-h-[44px] flex items-center` ✓; SwipeRow `min-h-[44px]` ✓; Habits 4×`text-lg` ✓ + active state ✓; Settings 7×`text-lg` ✓
