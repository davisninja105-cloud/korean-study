# Requirements Archive: v1.2 Performance & Snappiness
...
- [x] **SKEL-01**: User sees an instant skeleton on navigating to the cards page (no blank flash during route transition)
- [x] **SKEL-02**: User sees an instant skeleton on navigating to the study page
- [x] **SKEL-03**: User sees an instant skeleton on navigating to the habits page
- [x] **SKEL-04**: All skeletons use `bg-surface-2 animate-pulse` design-system tokens (no hardcoded grays)
...
|-------------|-------|--------|
| SKEL-01 | Phase 9 | Complete |
| SKEL-02 | Phase 9 | Complete |
| SKEL-03 | Phase 9 | Complete |
| SKEL-04 | Phase 9 | Complete |
