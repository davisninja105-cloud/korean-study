...
- [ ] v1.8 remaining performance requirements (P3.3–P3.7: `/study` round-trip collapse, freshness-backstop narrowing, local-first IndexedDB shell, service worker + offline queue) — see `.planning/REQUIREMENTS.md`; P3.0/P3.1/P3.5 shipped in Phase 30, P3.2 shipped in Phase 31
...
---
*Last updated: 2026-08-07 after Phase 31 (Cards List Pagination & Virtualization)*
