...
- [ ] v1.8 remaining performance requirements (P3.2–P3.7: cards pagination/virtualization, `/study` round-trip collapse, freshness-backstop narrowing, local-first IndexedDB shell, service worker + offline queue) — see `.planning/REQUIREMENTS.md`; P3.0/P3.1/P3.5 shipped in Phase 30
...
---
*Last updated: 2026-08-06 after Phase 30 (Instant Feedback & Cold-Start Unblocking)*
